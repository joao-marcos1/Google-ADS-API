...
def main(client, customer_id, brand='', number=''):
    ...
    if brand == "":
        ...
        campaign_budget.name = f"{brand} {number} budget"
    ...
    if brand == "":
        ...
        campaign.name = f"shopping campaign - {brand} {number}"
    ...
    try:
        ...
        campaign_str = campaign_response.results[0].resource_name
        campaign_id = campaign_str.split('/')[-1]
        return campaign_id
    except GoogleAdsException as ex:
        handle_googleads_exception(ex)
